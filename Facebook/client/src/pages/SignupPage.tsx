    ...
    <div className="min-h-screen bg-[#f0f2f5] flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center px-4 py-0">
        ...
        <div className="mt-[20px] mb-[16px]">
          <SiFacebook className="text-[#1877f2] w-[112px] h-[112px]" />
        </div>

        <div className="w-full max-w-[396px] bg-white rounded-[8px] shadow-[0_2px_4px_rgba(0,0,0,0.1),0_8px_16px_rgba(0,0,0,0.1)] px-4 py-[16px] mb-[16px]">
      ...
      {/* Meta Logo */}
      <footer className="mt-auto py-4 bg-white border-t border-[#dadde1]">
        <MetaLogo />
      </footer>
    </div>
  );
